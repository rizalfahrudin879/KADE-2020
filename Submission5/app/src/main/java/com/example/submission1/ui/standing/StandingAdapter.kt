...
class StandingAdapter(private val dataList: List<Standing>, private val listener: (Standing) -> Unit) :
    RecyclerView.Adapter<StandingAdapter.ViewHolder>() {

    class ViewHolder(override val containerView: View) : RecyclerView.ViewHolder(containerView),
        LayoutContainer {
        fun bind(item: Standing, listener: (Standing) -> Unit) {
            tv_name_standing.text = item.name
