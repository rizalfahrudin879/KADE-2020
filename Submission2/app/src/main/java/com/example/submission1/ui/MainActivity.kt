...
import com.example.submission1.ui.adapter.PagerAdapter
import com.example.submission1.ui.fragment.MatchFragment
import com.example.submission1.ui.fragment.TeamFragment
...
class MainActivity : AppCompatActivity(), MatchView {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        pagerAdapter = PagerAdapter(listLeague) {
            startActivity<DetailLeagueActivity>("id" to it.idLeague)
        }
